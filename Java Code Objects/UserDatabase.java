...
public class UserDatabase {
    ...
    public Admin getAdmin(String adminname) {
        ...
        if (countAdmin > 0) {
            ...
            //System.out.println("There are no admins in this database");
        }
	 ...
	 * Setter Methods
     */
    public void adminRegister(String an, String pw) {
        Admin newAdmin = new Admin(an, pw);
        /**
         * Add user to allAdmins array
         */
        if (adminsIsFull()) {
            System.out.print("Error. Cannot add admin");
        } else {
            System.out.print("Adding new user: " + an);
    ...
    public void adminLogin(String un, String pw) {
        ...
        if (findAdmin != null) {
            if (findAdmin.viewAdminPassword() == pw) {
            ...
            System.out.println("Sorry, invalid entry... no match for admin");
        }
    }
    ...
    /*
	public void userRegister (String un, String pw, String fn, String ln) {
